...
from cms_dataset import VisionPropDataset
...
def get_args():
    ...
    # CMS args
    parser.add_argument('--input_use_imgs', default=4, type=int, help='use images')
    parser.add_argument('--input_use_depth', default=0, type=int, help='use depth')
    parser.add_argument('--frame_skip', default=4, type=int, help='frame skip')
    parser.add_argument('--history_len', default=50, type=int, help='history_len')
    parser.add_argument('--latent_size', default=64, type=int, help='latent_size')
    parser.add_argument('--lookhead', default=[0.], type=float, nargs='+')
    parser.add_argument('--load_ckpt', default=0, type=int, help='load_ckpt')
    parser.add_argument('--latent_dim', default=10, type=int, help='latent_dim')
    parser.add_argument('--grayscale', default=0, type=int, help='grayscale')
...
def main(args, ds_init=None):
    ...
    utils.auto_load_model(
        ...
        optimizer=None, loss_scaler=loss_scaler, model_ema=model_ema)
    ...
    evals = {
        # "in_domain_ts": "/private/home/amirbar/datasets/CMS/up_down_policy_data/test",
        # "night": "/private/home/amirbar/datasets/CMS/data/new_policy/",
        "sand": "/private/home/amirbar/datasets/CMS/albany/sand",
        "grass": "/private/home/amirbar/datasets/CMS/albany/grass",
        "grass_sand": "/private/home/amirbar/datasets/CMS/albany/grass_sand",
        "sand_concrete": "/private/home/amirbar/datasets/CMS/albany/sand_concrete",
    }
    log_stats = {}
    for eval, eval_path in evals.items():
        start_time = time.time()
        dataset_val = VisionPropDataset(eval_path, config=args, transforms=transform_val, mode='test')
        test_stats = validation_one_epoch(dataset_val, model, device, args)
        loss = test_stats['loss']
        test_stats = {eval+'_'+k:v for k,v in test_stats.items()}
        print(f'Min loss {eval}: {loss:.3f}%')
