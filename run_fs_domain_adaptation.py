...
def main(args, ds_init=None):
    ...
    # dataset_train = VisionPropDataset(os.path.join("/private/home/amirbar/datasets/CMS/albany/sand_concrete_fs/", "train"), config=args, transforms=transform_train, mode='train')
    # dataset_val = VisionPropDataset(os.path.join("/private/home/amirbar/datasets/CMS/albany/sand_concrete_fs/", "test"), config=args, transforms=transform_val, mode='test')
    dataset_train = VisionPropDataset(os.path.join(args.data_path, "train"), config=args, transforms=transform_train, mode='train')
    dataset_val = VisionPropDataset(os.path.join(args.data_path, "test"), config=args, transforms=transform_val, mode='test')
