...
def build_dataset(is_train, test_mode, args):
    if args.data_set == 'Kinetics-400':
        ...
        dataset = VideoClsDataset(
            ...
            args=args)
        nb_classes = 51
    elif args.data_set == 'egopet':
        mode = None
        anno_path = None
        if is_train is True:
            mode = 'train'
            anno_path = '/private/home/amirbar/datasets/egopet/egopet_df_v2_mvd_train.csv'
        elif test_mode is True:
            mode = 'test'
            anno_path = '/private/home/amirbar/datasets/egopet/egopet_df_v2_mvd_val.csv'
        else:  
            mode = 'validation'
            anno_path = '/private/home/amirbar/datasets/egopet/egopet_df_v2_mvd_val.csv'
        ...
        if is_train is True:
            mode = 'train'
            anno_path = '/private/home/amirbar/datasets/egopet/ego4d_df_v2_mvd_train.csv'
        elif test_mode is True:
            mode = 'test'
            anno_path = None
        else:  
